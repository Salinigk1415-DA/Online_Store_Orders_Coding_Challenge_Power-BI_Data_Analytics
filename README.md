...
## Executive Summary
This document provides complete project documentation for the Online Store Orders data analysis and Power BI dashboard project. The initiative covers data acquisition, cleaning, exploratory analysis, and the development of an interactive business intelligence dashboard to support decision-making for an e-commerce operation.
## Project Overview
### Objectives
...
## Data Description
### Source Data
The source data is a single-sheet Excel workbook transactional records from an online retail store. Each row represents one order.
...
The near-equal split across five payment methods suggests the business has already optimised for payment flexibility. Recommended actions:
...
## Screenshort
<img width="1163" height="726" alt="Online Store Orders Screenshot" src="https://github.com/user-attachments/assets/b1e78056-9618-4cb8-9fdd-d84fbc96a87a" />
Tags

DataAnalytics # PowerBI #DataVisualization #DataAnalysis #PowerQuery #DataClean #AnalyticsDashboard #Reporting #Visualization